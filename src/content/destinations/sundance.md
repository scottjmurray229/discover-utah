...
budgetPerDay:
  ...
  midRange: 200
  luxury: 550
gettingThere: "50 minutes from Salt Lake City, 15 minutes from Provo via US-189 through Provo Canyon. Nestled at the base of Mount Timpanogos."
essentials:
  - icon: "✈️"
    label: "Getting There"
    value: "Fly into SLC (50 min drive) or use the Provo airport — the Provo Canyon drive is beautiful"
  - icon: "🚗"
    label: "Getting Around"
    value: "Car needed. The resort is self-contained but Provo Canyon and Heber Valley are worth exploring."
  - icon: "💰"
    label: "Daily Budget"
    value: "$50–$550 — boutique resort pricing but smaller and more intimate than the big resorts"
  - icon: "🏨"
    label: "Where to Base"
    value: "On-resort cottages for full immersion, Provo for budget options, Heber City for midvalley access"
  - icon: "🎬"
    label: "Film Culture"
    value: "Founded by Robert Redford — home of Sundance Institute programs, art galleries, and film screenings"
  - icon: "🔗"
    label: "Connections"
    value: "Provo 15 min, SLC 50 min, Park City 45 min, Timpanogos Cave 20 min"
highlights:
  - title: "Boutique Skiing"
    icon: "⛷️"
    image: ""
  - title: "Sundance Film Legacy"
    icon: "🎬"
    image: ""
  - title: "The Tree Room Restaurant"
    icon: "🍽️"
    image: ""
  - title: "Mount Timpanogos Views"
    icon: "🏔️"
    image: ""
  - title: "ZipTour"
    icon: "🪂"
  ...
  - title: "Fall Foliage"
    icon: "🍂"
    image: ""
gradientColors: "from-emerald-900 via-amber-800 to-red-900"
relatedDestinations:
  - slug: park-city
    videoSrc: ""
    hook: "45 minutes north — two world-class ski resorts, the Sundance Film Festival, and Historic Main Street"
  - slug: provo
    videoSrc: ""
    hook: "15 minutes west — BYU campus, Provo River Trail, and gateway to Provo Canyon"
  - slug: alta-snowbird
    videoSrc: ""
    hook: "60 minutes north — legendary powder skiing in Little Cottonwood Canyon"
faqItems:
  - question: "Is Sundance only for rich people?"
    answer: "Sundance has a boutique, upscale reputation, and the on-resort lodging and dining are premium-priced. But day skiing is reasonably priced compared to Park City or Deer Valley, and you can stay in Provo (15 minutes away) for a fraction of on-resort costs. The atmosphere is welcoming, not exclusive."
  - question: "What's the connection to the Sundance Film Festival?"
    answer: "Robert Redford founded both the resort and the Sundance Institute, which runs the festival. However, the festival itself takes place in Park City, not at Sundance Resort. The resort does host Sundance Institute programs and film screenings throughout the year, and the artistic ethos permeates everything from the architecture to the dining."
  - question: "How does the skiing compare to Alta/Snowbird or Park City?"
