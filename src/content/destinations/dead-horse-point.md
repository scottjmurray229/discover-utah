...
budgetPerDay:
  ...
  midRange: 100
  luxury: 250
gettingThere: "35 minutes from Moab via US-191 north and UT-313 west. Shares the same access road as Canyonlands Island in the Sky."
essentials:
  - icon: "✈️"
    label: "Getting There"
    value: "Fly into Grand Junction (2 hrs) or SLC (4 hrs), base in Moab — 35 min drive to the point"
  - icon: "🚗"
    label: "Getting Around"
    value: "Paved road to the overlook. Mountain bike trails loop through the park. No shuttle needed."
  - icon: "💰"
    label: "Daily Budget"
    value: "$30–$250 — $20 vehicle entry, combine with Canyonlands for a full-day value"
  - icon: "🏨"
    label: "Where to Base"
    value: "Moab for lodging and dining, Kayenta Campground in the park for sunrise access"
  - icon: "🚴"
    label: "Mountain Biking"
    value: "Intrepid Trail System with beginner to intermediate singletrack along the canyon rim"
  - icon: "🔗"
    label: "Connections"
    value: "Canyonlands Island in the Sky 15 min, Moab 35 min, Arches 45 min"
highlights:
  - title: "The Dead Horse Point Overlook"
    icon: "👁️"
    image: ""
  - title: "Colorado River Gooseneck"
    icon: "🌊"
    image: ""
  - title: "Intrepid Mountain Bike Trails"
    icon: "🚴"
    image: ""
  - title: "Sunset Photography"
    icon: "📸"
    image: ""
  - title: "Rim Walk Trail"
    icon: "🥾"
    image: ""
...
relatedDestinations:
  - slug: canyonlands
    videoSrc: ""
    hook: "15 minutes farther on the same road — vast canyon wilderness with Mesa Arch and Grand View Point"
  - slug: moab
    videoSrc: ""
    hook: "35 minutes east — adventure basecamp with world-class biking, rafting, and dining"
  - slug: arches
    videoSrc: ""
    hook: "45 minutes east — over 2,000 natural stone arches near Moab"
faqItems:
  - question: "Why is it called Dead Horse Point?"
    answer: "Legend says cowboys used the narrow neck of the peninsula as a natural corral, fencing off mustangs on the point. One group of horses was left behind and died of thirst within view of the Colorado River 2,000 feet below. Whether the story is entirely true or embellished, the geography — a narrow neck opening to a broad point surrounded by sheer cliffs — makes it plausible."
  - question: "Is Dead Horse Point worth visiting if I'm already going to Canyonlands?"
    answer: "Absolutely. The overlook at Dead Horse Point is arguably more dramatic than anything at Canyonlands — a sheer 2,000-foot drop directly to the Colorado River gooseneck. The park is on the same road as Canyonlands Island in the Sky, so combining them requires almost no extra driving."
  - question: "How long do I need at Dead Horse Point?"
