...
affiliatePicks:
  - name: "Provo Marriott Hotel and Conference Center"
    type: hotel
    url: "https://www.booking.com/region/us/utah.html?aid=2778866&ss=Provo+UT"
    description: "Central downtown Provo, walkable to Center Street dining."
    priceRange: "$$"
  - name: "Provo Canyon and Sundance Day Tour"
    type: tour
    url: "https://www.getyourguide.com/?partner_id=IVN6IQ3&q=Provo+Canyon+tour"
    description: "Guided Provo Canyon tour including Bridal Veil Falls and Sundance Resort area."
    priceRange: "$"
  - name: "Timpanogos Cave National Monument Tour"
    type: activity
    url: "https://www.getyourguide.com/?partner_id=IVN6IQ3&q=Timpanogos+Cave"
    description: "Guided cave tour in American Fork Canyon — spectacular helictite formations."
    priceRange: "$"
scottTips:
...
<div class="immersive-break-inline">
  <video autoplay muted loop playsinline preload="metadata">
    <source src="/videos/destinations/provo-hero.mp4" type="video/mp4" />
  </video>
  <div class="ib-gradient" style="background: linear-gradient(135deg, #1e40af, #0369a1, #166534);"></div>
  <div class="ib-content">
    <div class="ib-title">Provo: Canyon Country College Town</div>
    <p class="ib-text">Wasatch Range access, Provo Canyon, and a university city that surprises.</p>
  </div>
</div>
