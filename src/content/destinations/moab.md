...
heroVideo: ""
heroImage: ""
tagline: "Adventure capital of the American West"
...
budgetPerDay:
  ...
  midRange: 170
  luxury: 400
gettingThere: "230 miles southeast of Salt Lake City via I-15 and US-6, or via I-70. Nearest commercial airport: Grand Junction, CO (110 miles). Canyonlands Field airport has limited regional flights."
essentials:
  - icon: "✈️"
    label: "Getting There"
    value: "Fly into Grand Junction, CO (1.5 hrs) or SLC (3.5 hrs) — Moab's Canyonlands Field has limited flights"
  - icon: "🚗"
    label: "Getting Around"
    value: "Car essential for park access. Bike-friendly town. Several outfitters offer shuttle services for trails."
  - icon: "💰"
    label: "Daily Budget"
    value: "$50–$400 — BLM camping is free, but peak-season hotels are pricey"
  - icon: "🏨"
    label: "Where to Base"
    value: "Main Street for walkable dining and nightlife, Highway 191 corridor for chain hotels, BLM land for free camping"
  - icon: "🚴"
    label: "Biking"
    value: "World-class mountain biking — Slickrock Trail, Whole Enchilada, Porcupine Rim, and dozens more"
  - icon: "🔗"
    label: "Connections"
    value: "Arches 10 min, Canyonlands (Island in the Sky) 30 min, Dead Horse Point 35 min, Monument Valley 2.5 hrs"
highlights:
  - title: "Slickrock Mountain Bike Trail"
    icon: "🚴"
    image: ""
  ...
  - title: "Arches National Park"
    icon: "🏜️"
    image: ""
  - title: "Hell's Revenge 4x4 Trail"
    icon: "🚙"
    image: ""
  ...
  - title: "Fisher Towers"
    icon: "🗼"
    image: ""
gradientColors: "from-red-800 via-amber-700 to-orange-800"
relatedDestinations:
  - slug: arches
    videoSrc: ""
    hook: "10 minutes north — over 2,000 natural stone arches including iconic Delicate Arch"
  - slug: canyonlands
    videoSrc: ""
    hook: "30 minutes west — vast canyon wilderness with Mesa Arch, Grand View Point, and the White Rim"
  - slug: dead-horse-point
    videoSrc: ""
    hook: "35 minutes northwest — the most dramatic overlook in Utah, 2,000 feet above the Colorado River"
faqItems:
  - question: "How many days do I need in Moab?"
    answer: "A minimum of three days to see Arches, Canyonlands Island in the Sky, and Dead Horse Point with some time in town. A week lets you add mountain biking, rafting, the Needles district, a 4x4 trail, and time to actually relax. Moab is the kind of place where you keep extending your stay."
  - question: "Is Moab too touristy?"
    answer: "Moab has grown significantly, and peak-season weekends (spring and fall) are busy. But it retains genuine character — it's still a small town of about 5,000 people with local restaurants, independent shops, and a real community. The tourists are there for the outdoors, which keeps the vibe adventurous rather than commercial."
  - question: "Do I need to be an expert to mountain bike in Moab?"
...
- **Arches National Park** (10 min): The essential companion. Devote a full day to Delicate Arch, Devils Garden, and the Windows Section.
- **Canyonlands Island in the Sky** (30 min): Grand View Point, Mesa Arch at sunrise, and Upheaval Dome. Combined with Dead Horse Point for a full day.
- **Dead Horse Point State Park** (35 min): The single best overlook in Utah. Go at sunset.
- **Fisher Towers** (25 min via Hwy 128): Dark red mudstone towers along the Colorado — a surreal 4.4-mile hike.
- **Castle Valley & La Sal Mountain Loop** (1 hr loop): Drive through Castle Valley past the iconic Priest and Nuns formations and up into the La Sal Mountains for alpine scenery and panoramic views back to the desert below.
- **Canyonlands Needles District** (75 miles/1.5 hrs): The trail-focused district with banded sandstone towers and slot-canyon hiking. Worth the drive for a full day.
- **Newspaper Rock** (en route to Needles): One of the Southwest's best petroglyph panels, right off the road. Free.
