...
budgetPerDay:
  ...
  midRange: 80
  luxury: 200
gettingThere: "Multiple access points from Salt Lake City — Antelope Island (40 min), Great Saltair (20 min), Spiral Jetty (2.5 hrs via Brigham City)."
essentials:
  - icon: "✈️"
    label: "Getting There"
    value: "Fly into SLC — the lake's southern shore is 20 minutes from downtown, Antelope Island is 40 minutes"
  - icon: "🚗"
    label: "Getting Around"
    value: "Car needed to access different parts of the lake. Antelope Island has paved roads. Spiral Jetty requires dirt road."
  - icon: "💰"
    label: "Daily Budget"
    value: "$25–$200 — most access is free or low-cost, lodging in SLC or Ogden"
  - icon: "🏨"
    label: "Where to Base"
    value: "Salt Lake City or Ogden for lodging, Antelope Island for camping immersion"
  - icon: "🐦"
    label: "Birdwatching"
    value: "7.5 million migratory birds visit annually — one of the Western Hemisphere's most important bird habitats"
  - icon: "🔗"
    label: "Connections"
    value: "Salt Lake City 20 min, Antelope Island 40 min, Ogden 50 min, Bonneville Salt Flats 90 min"
highlights:
  - title: "Floating in Saltwater"
    icon: "🏊"
    image: ""
  - title: "Spiral Jetty"
    icon: "🌀"
    image: ""
  - title: "Migratory Bird Spectacle"
    icon: "🦆"
    image: ""
  ...
  - title: "Antelope Island"
    icon: "🦬"
    image: ""
gradientColors: "from-purple-800 via-pink-700 to-orange-600"
relatedDestinations:
  - slug: antelope-island
    videoSrc: ""
    hook: "The largest island in the lake — free-roaming bison, hiking, and the best Great Salt Lake access"
  - slug: salt-lake-city
    videoSrc: ""
    hook: "20 minutes from the lake's southern shore — mountain-ringed capital with skiing and culture"
  - slug: ogden
    videoSrc: ""
    hook: "50 minutes northeast — Union Station, Snowbasin, and gateway to northern Utah"
faqItems:
  - question: "Can you really float in the Great Salt Lake?"
    answer: "Yes — the lake's salinity ranges from 5% to 27% (compared to the ocean's 3.5%), making it nearly impossible to sink in the saltier sections. The north arm (above the railroad causeway) is the saltiest. Antelope Island's beaches on the south arm offer the most accessible floating experience. Rinse off thoroughly after — the brine is harsh on skin and especially eyes."
  - question: "Does the Great Salt Lake smell bad?"
    answer: "It can, particularly in late summer when brine flies are most active and decaying organic matter lines the shore. The smell is most noticeable at the south shore near Great Saltair. Antelope Island and the north shore tend to be less odorous. Spring and early summer are the least smelly seasons."
  - question: "What happened to the lake's water level?"
...
- **Antelope Island State Park** (40 min from SLC): The best way to experience the lake — bison, hiking, floating, and sunsets. Deserves its own full day.
- **Bonneville Salt Flats** (90 min west of SLC): Vast, perfectly flat salt flats where land speed records are set. Surreal and photogenic.
- **Golden Spike National Historic Park** (near Spiral Jetty): Where the transcontinental railroad was completed in 1869. Combine with a Spiral Jetty visit.
- **Bear River Bird Refuge** (near Brigham City): 12-mile auto tour through some of the most important wetland bird habitat in the West.
- **Stansbury Island** (south shore, west of SLC): A lesser-known peninsula with hiking trails and lake views, accessible by a rough road.
