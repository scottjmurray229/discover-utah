...
budgetPerDay:
  ...
  midRange: 150
  luxury: 350
gettingThere: "On the Utah-Arizona border along US-163. From Moab: 150 miles south (2.5 hours). From Monument Valley Airport: small charter flights only. Nearest commercial airports: Page, AZ (130 miles) or Grand Junction, CO (230 miles)."
essentials:
  - icon: "✈️"
    label: "Getting There"
    value: "Drive from Moab (2.5 hrs), Page AZ (2 hrs), or Kayenta AZ (30 min) — no major airports nearby"
  - icon: "🚗"
    label: "Getting Around"
    value: "Self-drive the 17-mile Valley Drive (unpaved, rough) or book a Navajo-guided tour for backcountry access"
  - icon: "💰"
    label: "Daily Budget"
    value: "$45–$350 — park entry $20/vehicle, guided tours add $60–$200"
  - icon: "🏨"
    label: "Where to Base"
    value: "The View Hotel for in-park views, Goulding's Lodge for historic character, Mexican Hat for budget"
  - icon: "🏛️"
    label: "Cultural Note"
    value: "Monument Valley is Navajo Nation land — respect tribal rules, hire Navajo guides for the best experience"
  - icon: "🔗"
    label: "Connections"
    value: "Moab 2.5 hrs, Lake Powell/Page 2 hrs, Grand Canyon South Rim 3 hrs, Canyon de Chelly 2 hrs"
highlights:
  - title: "West and East Mitten Buttes"
    icon: "🧤"
    image: ""
  - title: "Merrick and Mitchell Buttes"
    icon: "🏜️"
    image: ""
  ...
  - title: "Totem Pole"
    icon: "🗿"
    image: ""
  - title: "Navajo-Guided Tours"
    icon: "🦅"
    image: ""
gradientColors: "from-red-900 via-orange-900 to-amber-800"
relatedDestinations:
  - slug: moab
    videoSrc: ""
    hook: "2.5 hours north — adventure basecamp with Arches, Canyonlands, and world-class mountain biking"
  - slug: lake-powell
    videoSrc: ""
    hook: "2 hours west — houseboating, slot canyons, and the blue waters of Lake Powell"
  - slug: canyonlands
    videoSrc: ""
    hook: "3 hours north — vast canyon wilderness and America's most dramatic overlooks"
faqItems:
  - question: "Can I visit Monument Valley without a guide?"
    answer: "You can self-drive the 17-mile Valley Drive loop, which passes the major buttes and viewpoints. However, the most spectacular sites — Mystery Valley, Hunts Mesa, Teardrop Arch, and the backcountry formations — are only accessible with a licensed Navajo guide. I strongly recommend booking a guided tour for the deeper experience and cultural context."
  - question: "Is Monument Valley in Utah or Arizona?"
    answer: "Both. The Navajo Tribal Park straddles the Utah-Arizona border. The visitor center and most of the Valley Drive are in Arizona, but the iconic view from US-163 (the Forrest Gump road) is in Utah. The entire area is Navajo Nation sovereign territory."
