...
budgetPerDay:
  ...
  midRange: 160
  luxury: 400
gettingThere: "160 miles northeast of Las Vegas, 310 miles south of Salt Lake City. Nearest airport: St. George (45 miles). Mandatory shuttle in Zion Canyon March–November."
essentials:
  - icon: "✈️"
    label: "Getting There"
    value: "Fly into Las Vegas (2.5 hrs), St. George (45 min), or SLC (4.5 hrs) — drive to Springdale at the park entrance"
  - icon: "🚌"
    label: "Getting Around"
    value: "Mandatory free shuttle in Zion Canyon (March–November). No private vehicles on the scenic drive during shuttle season."
  - icon: "💰"
    label: "Daily Budget"
    value: "$45–$400 depending on camping vs. Springdale luxury lodging"
  - icon: "🏨"
    label: "Where to Base"
    value: "Springdale for walkable convenience, Zion Lodge for in-park, Virgin/Rockville for quiet and affordable"
  - icon: "🎫"
    label: "Park Pass"
    value: "$35 vehicle entry (7 days) or America the Beautiful Pass ($80/year)"
  - icon: "🔗"
    label: "Connections"
    value: "Bryce Canyon 85 miles, St. George 45 miles, Grand Canyon North Rim 115 miles, Las Vegas 160 miles"
highlights:
  - title: "The Narrows"
    icon: "🌊"
    image: ""
  ...
  - title: "Emerald Pools"
    icon: "💎"
    image: ""
gradientColors: "from-red-800 via-orange-700 to-amber-600"
relatedDestinations:
  - slug: bryce-canyon
    videoSrc: ""
    hook: "85 miles northeast — alien hoodoo landscapes and pristine dark sky stargazing"
  - slug: st-george
    videoSrc: ""
    hook: "45 miles southwest — warm year-round with Snow Canyon State Park and great dining"
  - slug: capitol-reef
    videoSrc: ""
    hook: "250 miles northeast — Utah's hidden gem with the Waterpocket Fold and free-range exploration"
faqItems:
  - question: "Do I need a permit for Angels Landing?"
    answer: "Yes. As of 2022, Angels Landing requires a permit obtained through a lottery system on Recreation.gov. There are seasonal lotteries (apply months ahead) and day-before lotteries. The permit is in addition to your park entrance fee. Without a permit, you can hike to Scout Lookout but cannot continue to the chains section and summit."
  - question: "Can beginners hike the Narrows?"
    answer: "Yes, the bottom-up day hike into the Narrows is suitable for reasonably fit beginners. You walk upstream in the Virgin River — water depth varies from ankle to waist-deep depending on season and flow. Rent waterproof boots, neoprene socks, and a walking stick from outfitters in Springdale. Check river conditions first — the hike closes during flash flood warnings."
  - question: "How many days do I need for Zion?"
