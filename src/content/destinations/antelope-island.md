...
budgetPerDay:
  ...
  midRange: 80
  luxury: 180
gettingThere: "40 minutes from downtown Salt Lake City. Take I-15 north to Syracuse, then west on the 7-mile causeway to the island."
essentials:
  - icon: "✈️"
    label: "Getting There"
    value: "Fly into SLC — 40 minutes north on I-15 to the Syracuse causeway entrance"
  - icon: "🚗"
    label: "Getting Around"
    value: "Paved road runs the length of the island. Car or bike for transportation between trailheads and beaches."
  - icon: "💰"
    label: "Daily Budget"
    value: "$25–$180 — $15 vehicle entry, affordable camping, bring your own food"
  - icon: "🏨"
    label: "Where to Base"
    value: "Island campground for immersion, Layton/Syracuse for hotels, SLC for full services"
  - icon: "🦬"
    label: "Wildlife"
    value: "700+ free-roaming bison, pronghorn antelope, mule deer, coyotes, and 250+ bird species"
  - icon: "🔗"
    label: "Connections"
    value: "SLC 40 min, Ogden 30 min, Great Salt Lake (same body of water), Farmington 20 min"
highlights:
  - title: "Free-Roaming Bison Herd"
    icon: "🦬"
    image: ""
  - title: "Great Salt Lake Floating"
    icon: "🏊"
    image: ""
  - title: "Frary Peak Summit"
    icon: "⛰️"
    image: ""
  ...
  - title: "Bird Migration"
    icon: "🦅"
    image: ""
gradientColors: "from-amber-700 via-purple-800 to-slate-700"
relatedDestinations:
  - slug: great-salt-lake
    videoSrc: ""
    hook: "The larger lake ecosystem — Spiral Jetty, bird refuges, and the surreal salt flats"
  - slug: salt-lake-city
    videoSrc: ""
    hook: "40 minutes south — mountain-ringed capital with world-class skiing, dining, and culture"
  - slug: ogden
    videoSrc: ""
    hook: "30 minutes northeast — Union Station, Snowbasin, and northern Utah adventure"
faqItems:
  - question: "Are the bison really wild?"
    answer: "They're free-roaming within the island but managed by the state. The herd of 700+ bison descends from 12 animals brought to the island in 1893. They graze across the island's grasslands and can appear anywhere, including on the road. Keep a safe distance — at least 75 feet — as they are wild animals and can be aggressive, especially during the fall rut."
  - question: "Does Antelope Island smell bad?"
    answer: "It can, particularly from late spring through early fall when brine flies are most active and the lake's receding shoreline exposes organic matter. The smell varies by day, wind direction, and location — some visits are odor-free, others are pungent. Spring and late fall tend to be least affected. The experience is worth tolerating a temporary smell."
  - question: "Can I swim in the Great Salt Lake at Antelope Island?"
