...
heroVideo: ""
heroImage: ""
tagline: "Utah's wildest, most untamed landscape"
...
budgetPerDay:
  ...
  midRange: 130
  luxury: 300
gettingThere: "Island in the Sky district is 30 minutes from Moab via US-191 and UT-313. The Needles district is 75 miles south of Moab via US-191 and UT-211."
essentials:
  - icon: "✈️"
    label: "Getting There"
    value: "Fly into Grand Junction (2 hrs to Island in the Sky) or SLC (4 hrs) — base in Moab for the closest access"
  - icon: "🚗"
    label: "Getting Around"
    value: "High-clearance 4WD needed for backcountry roads. Paved scenic drives in Island in the Sky and Needles districts."
  - icon: "💰"
    label: "Daily Budget"
    value: "$35–$300 — camping and BLM land keep costs low, Moab lodging adds up in peak season"
  - icon: "🏨"
    label: "Where to Base"
    value: "Moab for Island in the Sky, Monticello or Blanding for Needles, no lodging near the Maze"
  - icon: "🎫"
    label: "Park Pass"
    value: "$30 vehicle entry (7 days) or America the Beautiful Pass ($80/year)"
  - icon: "🔗"
    label: "Connections"
    value: "Arches 30 min, Dead Horse Point 15 min, Moab 30 min, Monument Valley 2.5 hrs"
highlights:
...
relatedDestinations:
  - slug: arches
    videoSrc: ""
    hook: "30 minutes northeast — over 2,000 natural stone arches and the iconic Delicate Arch"
  - slug: dead-horse-point
    videoSrc: ""
    hook: "15 minutes north — Utah's most dramatic overlook with a 2,000-foot sheer drop"
  - slug: moab
    videoSrc: ""
    hook: "30 minutes east — adventure basecamp with world-class mountain biking, rafting, and dining"
faqItems:
  - question: "What's the difference between Island in the Sky and the Needles?"
    answer: "Island in the Sky is the most accessible district — a high mesa with dramatic overlooks you can reach by short walks from parking areas. The Needles district is more remote and trail-focused, with colorful sandstone spires and backcountry loops. Most first-time visitors go to Island in the Sky; return visitors seeking deeper exploration head to the Needles."
  - question: "Do I need a 4WD vehicle?"
    answer: "Not for the paved scenic drives in Island in the Sky or Needles. But the park's famous backcountry roads — the White Rim Trail, Elephant Hill, and anything in the Maze district — absolutely require high-clearance 4WD. These are serious off-road routes, not just dirt roads."
  - question: "How is Canyonlands different from Arches?"
