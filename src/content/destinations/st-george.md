...
budgetPerDay:
  ...
  midRange: 140
  luxury: 350
gettingThere: "120 miles northeast of Las Vegas via I-15, 300 miles south of Salt Lake City via I-15. St. George Regional Airport (SGU) has limited commercial flights."
essentials:
  - icon: "✈️"
    label: "Getting There"
    value: "Fly into Las Vegas (2 hrs) or SLC (4.5 hrs) — St. George airport has regional flights from Denver, SLC, LA"
  - icon: "🚗"
    label: "Getting Around"
    value: "Car essential. The city is spread out. Bike-friendly with the Red Cliffs Desert Reserve trail network."
  - icon: "💰"
    label: "Daily Budget"
    value: "$40–$350 — affordable lodging, free hiking, golf packages available"
  - icon: "🏨"
    label: "Where to Base"
    value: "Downtown St. George for dining and convenience, Ivins for Snow Canyon proximity, Washington for newer hotels"
  - icon: "☀️"
    label: "Weather"
    value: "300+ days of sunshine annually — Utah's warmest city with mild winters and hot summers"
  - icon: "🔗"
    label: "Connections"
    value: "Zion 45 min, Snow Canyon 15 min, Bryce Canyon 2.5 hrs, Las Vegas 2 hrs, Grand Canyon North Rim 3 hrs"
highlights:
  - title: "Snow Canyon State Park"
    icon: "🏜️"
    image: ""
  - title: "Gateway to Zion"
    icon: "🏔️"
    image: ""
  ...
  - title: "Year-Round Sunshine"
    icon: "☀️"
    image: ""
gradientColors: "from-red-700 via-orange-600 to-amber-500"
relatedDestinations:
  - slug: zion
    videoSrc: ""
    hook: "45 minutes northeast — towering canyon walls, the Narrows, Angels Landing, and Utah's most-visited park"
  - slug: bryce-canyon
    videoSrc: ""
    hook: "2.5 hours northeast — otherworldly hoodoo formations and dark sky stargazing"
  - slug: lake-powell
    videoSrc: ""
    hook: "3 hours east — houseboating, slot canyons, and the blue waters of a desert reservoir"
faqItems:
  - question: "Is St. George just a Zion gateway or a destination itself?"
    answer: "Both, and increasingly the latter. Snow Canyon State Park alone would justify a visit — it's a stunning red rock landscape with lava fields, slot canyons, and sand dunes. Add the hiking trails of Red Cliffs Desert Reserve, a dozen golf courses, a growing restaurant scene, a charming pioneer downtown, and 300 days of sunshine, and St. George holds its own as a destination."
  - question: "How hot does St. George get in summer?"
    answer: "Very hot. June through September regularly exceeds 100°F, with July and August averaging 105-110°F. Summer is not the ideal time to visit unless you're exclusively golfing at dawn or swimming. The trade-off is that winter is magnificent — 50-65°F and sunny when the rest of Utah is under snow."
  - question: "Is Snow Canyon as good as Zion?"
    answer: "They're different experiences. Zion is bigger, more dramatic, and more crowded. Snow Canyon is smaller, quieter, and more varied — it has red and white sandstone, black lava flows, sand dunes, and petrified dunes all in one compact area. Many locals prefer Snow Canyon for everyday hiking because you can always find solitude."
  - question: "Is St. George a retirement community?"
    answer: "St. George has a significant retiree population, but it's rapidly diversifying. A growing university (Utah Tech), a tech sector, and an influx of younger outdoor recreation enthusiasts have changed the demographics. The dining and culture scene has expanded significantly in recent years."
affiliatePicks:
  - name: "Red Mountain Resort"
    type: hotel
    url: "https://www.booking.com/region/us/utah.html?aid=2778866&ss=St+George+UT"
    description: "Wellness resort in the red rock canyons near St. George. Hiking from the property."
    priceRange: "$$$"
  - name: "Snow Canyon State Park Guided Hike"
    type: tour
    url: "https://www.getyourguide.com/?partner_id=IVN6IQ3&q=Snow+Canyon+State+Park"
    description: "Guided hike through Snow Canyon's lava tubes and sandstone formations."
    priceRange: "$"
  - name: "St. George Shuttle to Zion"
    type: transport
    url: "https://www.getyourguide.com/?partner_id=IVN6IQ3&q=St+George+to+Zion+shuttle"
    description: "Shuttle service from St. George to Zion National Park entrance."
    priceRange: "$"
scottTips:
...
<div class="immersive-break-inline">
  <video autoplay muted loop playsinline preload="metadata">
    <source src="/videos/destinations/st-george-hero.mp4" type="video/mp4" />
  </video>
  <div class="ib-gradient" style="background: linear-gradient(135deg, #dc2626, #ea580c, #fbbf24);"></div>
  <div class="ib-content">
    <div class="ib-title">St. George: Sunny Desert City</div>
    <p class="ib-text">Red rock canyons, warm winters, and the gateway to Zion.</p>
  </div>
</div>
