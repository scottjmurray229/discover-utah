...
budgetPerDay:
  ...
  midRange: 80
  luxury: 180
gettingThere: "50 miles from Hanksville on UT-24, then south on Temple Mountain Road. About 3.5 hours from SLC, 1.5 hours from Moab, 50 miles from Capitol Reef."
essentials:
  - icon: "✈️"
    label: "Getting There"
    value: "Drive from Moab (1.5 hrs), Capitol Reef (1 hr), or SLC (3.5 hrs) — the park is remote, plan accordingly"
  - icon: "🚗"
    label: "Getting Around"
    value: "Paved road to the valley overlook. Explore the valley floor on foot — no trails needed, just wander."
  - icon: "💰"
    label: "Daily Budget"
    value: "$25–$180 — $20 vehicle entry, minimal services, bring your own food and water"
  - icon: "🏨"
    label: "Where to Base"
    value: "Camp in the park for the full experience, Hanksville for basic services, Green River for more options"
  - icon: "🏜️"
    label: "Unique Feature"
    value: "No marked trails in the valley — you're free to wander among thousands of mushroom-shaped rock formations"
  - icon: "🔗"
    label: "Connections"
    value: "Capitol Reef 50 miles, Moab 100 miles, San Rafael Swell adjacent, Hanksville 30 miles"
highlights:
  - title: "Goblin Valley Floor"
    icon: "👽"
    image: ""
  - title: "Little Wild Horse Canyon"
    icon: "🕳️"
    image: ""
  - title: "Wild Horse Butte Trail"
    icon: "🐎"
    image: ""
  ...
  - title: "Family Exploration"
    icon: "👨‍👩‍👧‍👦"
    image: ""
gradientColors: "from-amber-800 via-orange-700 to-red-800"
relatedDestinations:
  - slug: capitol-reef
    videoSrc: ""
    hook: "50 miles west — Utah's hidden gem with the Waterpocket Fold, orchards, and backcountry solitude"
  - slug: moab
    videoSrc: ""
    hook: "100 miles southeast — adventure basecamp for Arches, Canyonlands, and the Colorado River"
  - slug: canyonlands
    videoSrc: ""
    hook: "2 hours southeast — vast canyon wilderness with Mesa Arch and Grand View Point"
faqItems:
  - question: "What are the goblins?"
    answer: "The 'goblins' are mushroom-shaped hoodoos formed from Entrada sandstone — the same formation that creates the arches in Arches National Park. Here, differential erosion carved thousands of small, bulbous rock formations that look like aliens, mushrooms, or goblins depending on your imagination. They range from a few feet to over 15 feet tall."
  - question: "Is Goblin Valley good for kids?"
    answer: "Goblin Valley is one of the best parks in Utah for children. There are no cliffs, no dangerous drops, and no designated trails to follow. Kids are free to run around, climb on the formations, play hide-and-seek among the goblins, and explore at their own pace. It's essentially a natural playground."
