...
budgetPerDay:
  ...
  midRange: 200
  luxury: 600
gettingThere: "Wahweap Marina near Page, AZ is the primary access point — 275 miles south of SLC, 130 miles east of Kanab, 280 miles north of Phoenix."
essentials:
  - icon: "✈️"
    label: "Getting There"
    value: "Fly into Page, AZ (local airport) or Las Vegas/SLC and drive — Bullfrog Marina on the Utah side is 4 hrs from SLC"
  - icon: "🚗"
    label: "Getting Around"
    value: "Boat access essential for most of the lake. Marina boat rentals, guided tours, or personal watercraft."
  - icon: "💰"
    label: "Daily Budget"
    value: "$50–$600+ — houseboating is premium, day trips on powerboats are more moderate"
  - icon: "🏨"
    label: "Where to Base"
    value: "Page, AZ for the most services, Bullfrog Marina for Utah-side access, Halls Crossing for remote feel"
  - icon: "⛵"
    label: "On the Water"
    value: "185 miles of lake with 1,960 miles of shoreline — houseboats, kayaks, powerboats, and paddleboards"
  - icon: "🔗"
    label: "Connections"
    value: "Monument Valley 2 hrs, Grand Canyon North Rim 2.5 hrs, Bryce Canyon 3 hrs, Capitol Reef 3 hrs"
highlights:
  - title: "Houseboating"
    icon: "🛥️"
    image: ""
  ...
  - title: "Antelope Canyon"
    icon: "📸"
    image: ""
  - title: "Slot Canyon Kayaking"
    icon: "🛶"
    image: ""
  - title: "Glen Canyon Dam"
    icon: "🏗️"
    image: ""
gradientColors: "from-blue-800 via-cyan-700 to-red-800"
relatedDestinations:
  - slug: monument-valley
    videoSrc: ""
    hook: "2 hours east — the iconic buttes and mesas of Navajo Nation land"
  - slug: bryce-canyon
    videoSrc: ""
    hook: "3 hours north — otherworldly hoodoo formations and dark sky stargazing"
  - slug: capitol-reef
    videoSrc: ""
    hook: "3 hours north — Utah's hidden gem with the Waterpocket Fold and free fruit orchards"
faqItems:
  - question: "What's happening with Lake Powell's water levels?"
    answer: "Lake Powell has experienced dramatic water level fluctuations due to prolonged drought and Colorado River water management challenges. At its lowest recent point, the lake dropped over 100 feet from full pool, exposing previously submerged canyons and threatening the dam's ability to generate hydroelectric power. Water levels fluctuate year to year — check current conditions before planning a trip, as some marinas and launch ramps may be closed or modified."
  - question: "Is houseboating worth the cost?"
    answer: "If you can split the cost with a group, absolutely. A houseboat for a week typically costs $3,000–$10,000+ depending on size and season. Split among 8-12 people, it becomes comparable to hotel stays. The experience — sleeping on the lake, exploring side canyons by kayak, jumping off the roof into blue water — is unlike anything else. Book 6+ months in advance for summer."
  - question: "Can I visit without a boat?"
