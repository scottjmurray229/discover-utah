...
budgetPerDay:
  ...
  midRange: 140
  luxury: 350
gettingThere: "270 miles south of Salt Lake City via I-15. Nearest airports: Cedar City (80 miles), St. George (125 miles), or Las Vegas (265 miles)."
essentials:
  - icon: "✈️"
    label: "Getting There"
    value: "Drive from SLC (4 hrs), Las Vegas (4 hrs), or Cedar City regional airport (1.5 hrs)"
  - icon: "🚗"
    label: "Getting Around"
    value: "Free park shuttle runs May–October along the 18-mile scenic drive. Personal vehicle allowed year-round."
  - icon: "💰"
    label: "Daily Budget"
    value: "$40–$350 depending on camping vs. lodge — limited lodging options near the park"
  - icon: "🏨"
    label: "Where to Base"
    value: "The Lodge at Bryce Canyon for in-park luxury, Bryce Canyon City for budget options, Tropic for local charm"
  - icon: "🎫"
    label: "Park Pass"
    value: "$35 vehicle entry (7 days) or use America the Beautiful Pass ($80/year)"
  - icon: "🔗"
    label: "Connections"
    value: "Zion 85 miles, Capitol Reef 120 miles, Grand Staircase-Escalante adjacent, Cedar Breaks 55 miles"
highlights:
  - title: "Hoodoo Amphitheaters"
    icon: "🏜️"
    image: ""
  ...
  - title: "Rim Trail"
    icon: "🛤️"
    image: ""
gradientColors: "from-orange-900 via-red-700 to-pink-800"
relatedDestinations:
  - slug: zion
    videoSrc: ""
    hook: "85 miles southwest — towering canyon walls, the Narrows, and Angels Landing"
  - slug: capitol-reef
    videoSrc: ""
    hook: "120 miles northeast — the quiet gem of Utah's Mighty Five with the Waterpocket Fold"
  - slug: st-george
    videoSrc: ""
    hook: "125 miles southwest — warm-weather basecamp for Zion, Snow Canyon, and year-round golf"
faqItems:
  - question: "What exactly are hoodoos?"
    answer: "Hoodoos are tall, thin rock spires formed by frost wedging and rain erosion over millions of years. The soft limestone and mudstone layers erode at different rates, creating pillars topped with harder capstones. Bryce Canyon has the largest concentration of hoodoos anywhere on Earth."
  - question: "Is Bryce Canyon actually a canyon?"
    answer: "Technically no — it's a series of natural amphitheaters eroded into the eastern edge of the Paunsaugunt Plateau. Unlike a canyon carved by a river, Bryce was formed by frost weathering and stream erosion along the plateau's edge. The distinction doesn't make it any less spectacular."
  - question: "How many days do I need at Bryce Canyon?"
...
affiliatePicks:
  ...
  - name: "Microspikes for Hiking"
    type: activity
    url: "https://www.amazon.com/s?k=utah+travel&tag=discoverphili-20&k=microspikes+hiking"
