...
heroVideo: ""
heroImage: ""
tagline: "Nature's greatest sculpture garden"
...
budgetPerDay:
  ...
  midRange: 150
  luxury: 350
gettingThere: "5 miles north of Moab on US-191. Fly into Grand Junction, CO (110 miles) or Salt Lake City (230 miles). Shuttle service required for main scenic drive in peak season."
essentials:
  - icon: "✈️"
    label: "Getting There"
    value: "Fly into Grand Junction (1.5 hrs) or SLC (3.5 hrs), then drive to Moab — park entrance 5 min north of town"
  - icon: "🚗"
    label: "Getting Around"
    value: "Timed entry reservation required April–October. Free park shuttle being expanded. Personal vehicle for off-peak."
  - icon: "💰"
    label: "Daily Budget"
    value: "$40–$350 depending on camping vs. Moab resort lodging"
  - icon: "🏨"
    label: "Where to Base"
    value: "Moab for restaurants and lodging, Devils Garden Campground inside the park for immersion"
  - icon: "🎫"
    label: "Park Pass"
    value: "$30 vehicle entry (7 days) or use America the Beautiful Pass ($80/year for all national parks)"
  - icon: "🔗"
    label: "Connections"
    value: "Canyonlands 30 min, Dead Horse Point 40 min, Moab 10 min, Monument Valley 2.5 hrs"
highlights:
  - title: "Delicate Arch"
    icon: "🏜️"
    image: ""
  ...
  - title: "Park Avenue"
    icon: "🏙️"
    image: ""
gradientColors: "from-red-900 via-orange-800 to-amber-700"
relatedDestinations:
  - slug: moab
    videoSrc: ""
    hook: "10 minutes south — your basecamp for adventure with restaurants, gear shops, and river outfitters"
  - slug: canyonlands
    videoSrc: ""
    hook: "30 minutes southwest — the big, wild sibling with vast canyon views and backcountry solitude"
  - slug: dead-horse-point
    videoSrc: ""
    hook: "40 minutes southwest — one of the most photographed overlooks in the American West"
faqItems:
  - question: "Do I need a reservation to visit Arches?"
    answer: "Yes, from April through October you need a timed entry reservation in addition to your park entrance fee. Reservations open on Recreation.gov and sell out fast — book as soon as they become available, typically three months in advance. Off-season (November–March) requires no reservation."
  - question: "How long does it take to hike to Delicate Arch?"
    answer: "The Delicate Arch Trail is 3 miles roundtrip with 480 feet of elevation gain. Most people complete it in 1.5 to 2 hours. Go in the late afternoon for the best light and that iconic sunset glow on the arch. Bring water — there is zero shade on this hike."
  - question: "Is one day enough for Arches?"
...
- **Canyonlands Island in the Sky** (30 min): The overlooks here are even more dramatic than Arches. Don't miss Grand View Point and Mesa Arch at sunrise.
- **Dead Horse Point State Park** (40 min): The single most dramatic overlook in Utah — a 2,000-foot sheer drop to a Colorado River gooseneck.
- **Fisher Towers** (25 min): A surreal trail through dark red mudstone towers along the Colorado River. 4.4 miles roundtrip.
- **Corona Arch Trail** (20 min): A free-to-access arch that rivals anything inside the park. Short hike with a cable-assisted scramble section.
- **Castle Valley** (30 min): Drive the La Sal Mountain Loop Road for alpine scenery and views back down to the red desert below.
- **Colorado River Float** (Moab): Half-day rafting trips on calm water through red rock canyons — perfect for families.
