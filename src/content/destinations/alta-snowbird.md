...
budgetPerDay:
  ...
  midRange: 250
  luxury: 700
gettingThere: "Little Cottonwood Canyon, 35 minutes from downtown Salt Lake City and 45 minutes from SLC airport. Accessible via UT-210 from Sandy."
essentials:
  - icon: "✈️"
    label: "Getting There"
    value: "Fly into SLC — 45 minutes to the base of Little Cottonwood Canyon via I-15 and UT-210"
  - icon: "🚗"
    label: "Getting Around"
    value: "UTA ski buses from SLC, car with traction devices required in winter, canyon road closures for avalanche control"
  - icon: "💰"
    label: "Daily Budget"
    value: "$60–$700 — lift tickets $120–$250/day, lodging ranges from bunks to luxury"
  - icon: "🏨"
    label: "Where to Base"
    value: "Alta Lodge or Snowbird's Cliff Lodge for slope-side, Sandy/Cottonwood Heights for budget, SLC for variety"
  - icon: "⛷️"
    label: "Ski Stats"
    value: "500+ inches annual snowfall, 4,700 combined acres, terrain from bunny slopes to extreme chutes"
  - icon: "🔗"
    label: "Connections"
    value: "SLC 35 min, Park City 50 min (via canyon roads in summer), Brighton/Solitude 20 min (Big Cottonwood)"
highlights:
  - title: "Powder Skiing"
    icon: "❄️"
    image: ""
  ...
  - title: "Little Cottonwood Canyon"
    icon: "🏔️"
    image: ""
gradientColors: "from-blue-900 via-slate-700 to-cyan-800"
relatedDestinations:
  - slug: salt-lake-city
    videoSrc: ""
    hook: "35 minutes down the canyon — world-class dining, culture, and nightlife after a day on the slopes"
  - slug: park-city
    videoSrc: ""
    hook: "50 minutes via I-80 — two more resorts, the Sundance Film Festival, and Historic Main Street"
  - slug: sundance
    videoSrc: ""
    hook: "Robert Redford's boutique ski resort in Provo Canyon — intimate, artistic, and uncrowded"
faqItems:
  - question: "What's the difference between Alta and Snowbird?"
    answer: "Alta is a skiers-only resort (no snowboarders) with a classic, no-frills vibe, legendary powder stashes, and a loyal following. Snowbird is larger, allows snowboarders, has the iconic aerial tram, and offers a more modern resort experience. An AltaBird pass connects both resorts via the Sugarloaf lift. Together they offer 4,700 acres and over 500 inches of annual snow."
  - question: "Why can't snowboarders ride at Alta?"
    answer: "Alta is one of only three remaining ski areas in the US that does not allow snowboarding. The policy has survived multiple legal challenges and is rooted in the resort's traditional skiing culture. The Supreme Court declined to hear a case challenging the ban. Snowboarders can ride next door at Snowbird, which has the same snow quality."
  - question: "Is the drive up Little Cottonwood Canyon scary?"
...
- **Big Cottonwood Canyon / Brighton & Solitude** (20 min via Guardsman Pass in summer only): Two more ski resorts in the adjacent canyon with excellent terrain and a different vibe.
- **Salt Lake City** (35 min): Downtown dining, Temple Square, craft breweries, and the Natural History Museum.
- **Park City** (50 min via I-80 in winter, shorter via Guardsman Pass in summer): Two more resorts, Historic Main Street, and the Sundance Film Festival scene.
- **Timpanogos Cave** (45 min south): Limestone cave system in American Fork Canyon with guided tours.
- **Bonneville Shoreline Trail** (at canyon base): A long trail along the ancient Lake Bonneville shoreline with valley and canyon views.
