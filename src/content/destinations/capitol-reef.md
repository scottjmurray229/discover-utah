...
heroVideo: ""
heroImage: ""
tagline: "Utah's best-kept secret in stone"
...
budgetPerDay:
  ...
  midRange: 120
  luxury: 280
gettingThere: "From SLC, take I-15 south to US-50 to UT-24 — about 3.5 hours. From Moab, take I-70 west to UT-24 south — about 2.5 hours. The town of Torrey is the gateway."
essentials:
  - icon: "✈️"
    label: "Getting There"
    value: "Drive from SLC (3.5 hrs), Moab (2.5 hrs), or Bryce Canyon (2 hrs) — fly into SLC for best access"
  - icon: "🚗"
    label: "Getting Around"
    value: "Scenic Drive requires $20 fee. Cathedral Valley needs high-clearance 4WD. Highway 24 through the park is free."
  - icon: "💰"
    label: "Daily Budget"
    value: "$30–$280 — one of Utah's most affordable national parks with free fruit picking in season"
  - icon: "🏨"
    label: "Where to Base"
    value: "Torrey for the best dining and lodging, Fruita Campground for in-park experience, Bicknell for budget options"
  - icon: "🍎"
    label: "Free Fruit"
    value: "Pick cherries, apricots, peaches, pears, and apples in Fruita's historic orchards — free when in season"
  - icon: "🔗"
    label: "Connections"
    value: "Bryce Canyon 120 miles, Moab 150 miles, Goblin Valley 50 miles, Grand Staircase-Escalante adjacent"
highlights:
  - title: "Waterpocket Fold"
    icon: "🏔️"
    image: ""
  - title: "Fruita Historic Orchards"
    icon: "🍑"
    image: ""
  ...
  - title: "Petroglyphs"
    icon: "🪨"
    image: ""
gradientColors: "from-amber-800 via-yellow-700 to-red-800"
relatedDestinations:
  - slug: bryce-canyon
    videoSrc: ""
    hook: "120 miles southwest — otherworldly hoodoo formations and dark sky stargazing"
  - slug: goblin-valley
    videoSrc: ""
    hook: "50 miles east — mushroom-shaped rock formations in a landscape straight out of science fiction"
  - slug: moab
    videoSrc: ""
    hook: "150 miles east — adventure basecamp for Arches, Canyonlands, and Colorado River activities"
faqItems:
  - question: "Why do people call Capitol Reef the 'hidden gem' of Utah?"
    answer: "Capitol Reef receives about 1.2 million visitors annually — less than a third of Zion's traffic. Its location in south-central Utah, away from the I-15 corridor, means many road trippers skip it. Those who visit find a park with stunning geology, free fruit orchards, excellent hiking, and solitude that the more famous parks can't offer."
  - question: "What is the Waterpocket Fold?"
    answer: "The Waterpocket Fold is a 100-mile-long monocline — a step-up in the earth's crust — created 50-70 million years ago when tectonic forces buckled the landscape. The result is an immense wrinkle in the earth's surface with exposed rock layers spanning 250 million years of geological history. The park was created specifically to protect this formation."
  - question: "Can I really pick free fruit in the park?"
