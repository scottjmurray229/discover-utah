...
budgetPerDay:
  ...
  midRange: 120
  luxury: 280
gettingThere: "130 miles north of Salt Lake City via I-15 and US-89 through Logan Canyon — about 2.5 hours."
essentials:
  - icon: "✈️"
    label: "Getting There"
    value: "Fly into SLC (2.5 hrs drive) — the Logan Canyon scenic drive to Bear Lake is stunning"
  - icon: "🚗"
    label: "Getting Around"
    value: "Car essential. US-89 runs along the west shore. Small towns at the north and south ends."
  - icon: "💰"
    label: "Daily Budget"
    value: "$35–$280 — affordable family destination with campgrounds, cabins, and lake rentals"
  - icon: "🏨"
    label: "Where to Base"
    value: "Garden City for lakeside access, Laketown for quiet south shore, Fish Haven for Idaho side charm"
  - icon: "🍓"
    label: "Must Try"
    value: "Bear Lake raspberry shakes — the region grows a unique variety of raspberry found only here"
  - icon: "🔗"
    label: "Connections"
    value: "Logan 40 min, SLC 2.5 hrs, Ogden 2 hrs, Yellowstone 3.5 hrs"
highlights:
  - title: "Turquoise Water"
    icon: "💎"
    image: ""
  - title: "Raspberry Shakes"
    icon: "🍓"
    image: ""
  - title: "Bear Lake State Park"
    icon: "🏖️"
    image: ""
  - title: "Logan Canyon Scenic Byway"
    icon: "🛣️"
    image: ""
  - title: "Water Sports"
    icon: "🚤"
    image: ""
gradientColors: "from-cyan-800 via-teal-700 to-blue-800"
relatedDestinations:
  - slug: great-salt-lake
    videoSrc: ""
    hook: "A completely different lake experience — hypersaline floating, Spiral Jetty, and migratory birds"
  - slug: ogden
    videoSrc: ""
    hook: "2 hours southwest — Union Station, Snowbasin resort, and access to northern Utah skiing"
  - slug: salt-lake-city
    videoSrc: ""
    hook: "2.5 hours south — mountain-ringed capital with world-class skiing, dining, and culture"
faqItems:
  - question: "Why is Bear Lake so blue?"
    answer: "Bear Lake's distinctive turquoise color comes from suspended calcium carbonate particles in the water, which scatter light in a way that produces an intense blue-green hue. The lake is unusually deep (208 feet) and the mineral-rich water gives it a color more associated with tropical lagoons than mountain lakes. It's genuinely startling the first time you see it."
  - question: "What's the deal with the raspberry shakes?"
    answer: "The Bear Lake region grows a unique variety of raspberry — the Bear Lake raspberry — that's slightly sweeter and more aromatic than common varieties. Raspberry shakes, jams, and candies are the local specialty, and multiple drive-ins in Garden City compete for the title of best shake. The Annual Raspberry Days festival in August is a big draw."
  - question: "Is Bear Lake good for swimming?"
